...
import 'echarts-gl';
import chinaData from './mapData/100000.json';
...
const Threemap = (props) => {
  ...
  function echartsTest() {
    var myChart = echarts.init(document.getElementById('threemap'));
    myChart.hideLoading();
      ...
      series: [
        {
          ...
          itemStyle: {
            //opacity: 1, // 透明度
            color: 'rgba(0, 67, 89, 1)', //地图颜色
            //borderWidth: 1.5,//分界线宽度
            //borderColor: "#459bca",//分界线颜色
            areaColor: 'rgba(0, 67, 89, 1)',
            //color: '#6554C0',
            opacity: 1,
            borderWidth: 0.5,
            borderColor: 'rgba(19, 37, 53, 1)',
          },
          // 鼠标hover高亮
          emphasis: {
            label: {
  ...
  return <div id="threemap" style={{ width: '100%', height: '100%' }}></div>;
};
